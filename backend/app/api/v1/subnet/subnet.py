...
@subnet_bp.route('/subnet', methods=['POST'])
@token_required
...
@subnet_bp.route('/subnet/<subnet_id>', methods=['PUT'])
@token_required
...
@subnet_bp.route('/subnet/<subnet_id>', methods=['DELETE'])
@token_required
